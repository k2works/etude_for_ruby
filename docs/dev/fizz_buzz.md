...
![](assets/fizz_buzz/a3f7a2b5adc6a1c63cf76b9f21d259aa0.png?0.25625089203678275)  
### シーケンス図
  
#### execute
  

![](assets/fizz_buzz/a3f7a2b5adc6a1c63cf76b9f21d259aa1.png?0.11338401461137138)  
  

![](assets/fizz_buzz/a3f7a2b5adc6a1c63cf76b9f21d259aa2.png?0.16447832427527564)  
  

![](assets/fizz_buzz/a3f7a2b5adc6a1c63cf76b9f21d259aa3.png?0.38748257797585817)  
  

![](assets/fizz_buzz/a3f7a2b5adc6a1c63cf76b9f21d259aa4.png?0.057227064877673595)  
...
**単一責任の原則**従い追加したクラスをファイル単位に分割する。新しいパターンが発生した場合は対象クラスを追加することで対応でき**オープン・クローズドの原則**に従った構造にした。
...
+ 実装
  + **Strategyパターン**を実装する。
  + **FactoryMethodパターン**を実装する。
  + **Commandパターン**を実装する。
  + **NullObjectパターン**を実装する。
