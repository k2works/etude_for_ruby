...
![](assets/fizz_buzz/a3f7a2b5adc6a1c63cf76b9f21d259aa0.png?0.007916013495133711)  
### シーケンス図
  

![](assets/fizz_buzz/a3f7a2b5adc6a1c63cf76b9f21d259aa1.png?0.5544151533702995)  
...
**週次サイクル**のイテレーション２を開始するにあたって前回の**ふりかえり**内容を繰越してKPTフレームワークを適用する。
...
+ 設計
  + イテレーション１と同様に**TODOリスト**を作成して**インクリメンタルな設計**を実行した。
  + **単一責任の原則**に従い設計を見直した。
+ 実装
  + **例外**を実装してテストを実行した結果仕様を満たせなくなることがわかった。
  + テストが**回帰テスト**として機能したおかけでプログラムの不具合を想起に発見できた。
